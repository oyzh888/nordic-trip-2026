...
/* ===== 10/2 五 · 飞特罗姆瑟 ===== */
 ...
 {lane:'fly', s:'2026-10-02T15:40', e:'2026-10-02T16:35', t:'✈ <b>WF816 Leknes → 特罗姆瑟</b>（Widerøe Dash-8，直飞 55 min）',
  ...
  {lane:'car', s:'2026-10-02T17:00', e:'2026-10-05T10:00', t:'✅ 🇳🇴 车② · <b>Mercedes-Benz EQS 4WD（纯电）</b>· SIXT（TOS 取还）',
  ...
  note:'✅ <b>2026-09-06 已下单。</b>航站楼内取车 → 落地 16:35、取车 17:00 = <b>等 25 分钟</b>。'+
    ...
    '<br>🔴 <b>这台是纯电的 EQS，而 10/4 要跑 Senja 往返 500 km（10 月 · 山路 · 夜里还在外面追极光）—— 这是全程唯一需要提前做功课的一天。</b>'+
    'EQS 电池大（约 107 kWh），但<b>低温 + 暖风 + 山路会把续航按下来</b>，500 km 现实里要算<b>一次充电停留</b>。'+
    '行动项：出发前在地图上标好 Senja 线上的快充点（Finnsnes 一带），并确认特罗姆瑟住处能不能过夜充。'+
    '⚠️ 另外 EQS 是<b>低底盘轿车</b>不是 SUV —— 10 月挪威北部山路遇到雪或碎石要开慢点。'},
...
const TOFILL = [
 ...
 {p:'🟠 出发前要做功课', what:'🔌 <b>三台挪威车都是纯电 —— 只有 10/4 那天需要提前规划</b>', who:'Steve',
  why:'挪威是全世界充电桩最密的地方，四段里三段完全不用担心（罗弗敦 175 km 一次续航内；奥斯陆往返 Stange 只 30–40 分钟）。'+
      ...
      '（罗弗敦 Nordic Lodge / 特罗姆瑟那套 / Stange 小屋）。⚠️ 另外 EQS 是低底盘轿车不是 SUV，山路遇雪要开慢',
