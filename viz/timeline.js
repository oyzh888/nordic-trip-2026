...
/* ===== 9/24 四 · 落地奥斯陆 ===== */
 {lane:'fly', s:'2026-09-24T21:30', e:'2026-09-24T22:10', t:'✈ 北京首都 T2 → 奥斯陆（9h25，已出票）',
  st:'ok', who:'携程订单（预订号见本地记录，不进公开仓库）', note:'✅ <b>2026-09-04 已出票</b>（携程截图）。🟠 <b>还差两件事</b>：① <b>落地钟点</b> —— 截图上被裁掉了，时间线里 21:30 还是占位值；② 那一段<b>只显示 1 位出行人</b>，仍要确认 4 个人是不是同一班。🆕 <b>2026-09-22 进展：9/29 那班 DY1171 已经确认 4 人齐了</b>（出行人栏展开后四个名字都在），所以<b>还没确认人数的只剩两段：9/24 洲际 和 9/25 SK4787</b>（后者出行人栏仍是折叠的）。⚠️ 姓名和预订号<b>故意不写进这个公开仓库</b>）'},
...
/* ===== 9/30 三 · 进罗弗敦 ===== */
 {lane:'fly', s:'2026-09-30T08:55', e:'2026-09-30T10:35', t:'✈ OSL → EVE 埃沃内斯（Norwegian 08:55→10:35）',
  ...
  {lane:'car', s:'2026-09-30T11:00', e:'2026-10-02T14:30', t:'✅ 🇳🇴 车① · <b>Toyota RAV 4WD</b> · Standard · 自动挡 · SIXT（EVE 取 → Leknes 还）',
...
/* ===== 10/2 五 · 飞特罗姆瑟 ===== */
 ...
 {lane:'fly', s:'2026-10-02T15:40', e:'2026-10-02T16:35', t:'✈ <b>WF816 Leknes → 特罗姆瑟</b>（Widerøe Dash-8，直飞 55 min）',
  ...
  {lane:'car', s:'2026-10-02T17:00', e:'2026-10-05T17:00', t:'✅ 🇳🇴 车② · <b>Volvo V90 4WD</b> 或同级 Premium · 自动挡 · SIXT（TOS 取还）',
