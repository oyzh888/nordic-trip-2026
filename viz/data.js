...
const CARPTS = [
  ...
  {k:'pick', c:P.eve,    label:'✅ 挪威提车①', when:'9/30 11:00', car:'Toyota RAV 4WD · Standard · 自动挡 · SIXT · $952.49',
   note:'已确认。落地 10:35 → 11:00 取车；异地还车 LKN；押金预授权 $1,470。'},
  {k:'drop', c:P.lknair, label:'✈️ 还车① Leknes 机场（LKN）', when:'10/2 14:30', car:'Toyota RAV 4WD · 自动挡',
   note:'已确认：EVE → LKN 异地还车。距 WF816 15:40 起飞 70 分钟；Lyngvær → Leknes 63.6 km / 1h16。'},
  {k:'pick', c:P.tosair, label:'✅ 挪威提车②', when:'10/2 17:00', car:'Volvo V90 4WD · Premium · 自动挡 · SIXT · $401.88',
   note:'已确认。16:35 落地 → 17:00 取车；押金 $1,450；免费取消至 9/30 17:00。'},
  {k:'drop', c:P.tosair, label:'挪威还车②', when:'10/5 **17:00**', car:'Volvo V90 4WD · Premium · 自动挡',
   note:'已确认到 17:00，与取车时间刚好满 72 小时。'},
...
const DAYS = [
  ...
  },
  {
    ...
    car:{name:'✅ Toyota RAV 4WD · Standard · 自动挡 · SIXT',
         seg:'罗弗敦：EVE 9/30 11:00 → LKN 10/2 14:30（3 天）',
         price:'$952.49：已付 $25.55 · 取车付 $926.94',cny:'¥6,762',
         url:U.dcars, pick:P.eve, drop:P.lknair, pickWhen:'9/30 11:00', dropWhen:'10/2 14:30',
         note:'已确认：自动挡、5 座、异地还车。取车付租金 $601.73 + 异地还车费 $325.21；押金 $1,470。'},
    spend:{stay:3592, car:6762}, supply:'amber',
  ...
  },
  {
    ...
    spend:{stay:4069, car:2853, other:5960}, supply:'amber',
...
const CARTAB=[
  ...
  {u:U.dcars, chk:'✅ 已确认 · SIXT', seg:'🇳🇴 车① 罗弗敦', car:'Toyota RAV 4WD · Standard · 自动挡', when:'EVE **9/30 11:00** → **Leknes(LKN) 10/2 14:30**（3 天）',
   p:'$952.49', cny:'¥6,762',
   note:'✅ 已付 $25.55，取车付 $926.94（租金 $601.73 + 异地还车费 $325.21）。押金 $1,470。'},
  {u:U.dcars, chk:'✅ 已确认 · SIXT · 免费取消至 9/30 17:00', seg:'🇳🇴 车② 特罗姆瑟', car:'Volvo V90 4WD · Premium · 自动挡', when:'TOS **10/2 17:00** → **10/5 17:00**（3 天）',
   p:'$401.88', cny:'¥2,853',
   note:'✅ 已付 $30.18，取车付 $371.70。押金 $1,450；CDW 自付额 $2,155；取车在 TOS 航站楼内。'},
