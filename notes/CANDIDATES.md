...
| 9/30 → 10/2 罗弗敦（2 晚）**✅ 已订** | Nordic Lodge Retreat ★4.92 · 4房8床2卫 · €898 · **可退** | Waterfront Nordic house ★4.93 · 5房8床2卫 · €553 · 可退 | ¥2,760（**已订，不建议改**） |

## 默认组合的总账（网页版的默认选中项）

| | |
|---|---:|
| 住宿合计（12 晚 · 4 人） | **¥41,055** |
| 折算 | **¥1,711 / 房 / 晚** |
| 你的预算 | ¥2,000–4,000 / 房 |
| 结论 | ✅ 仍在区间下沿内（我原来那套是 ¥1,326 —— 两套都在预算内） |
| 条件性的 10/6 那一晚（未计入，等 Kevin 机票） | ¥1,544 |

---

## 9/24 → 9/25（周四入住） · Oslo Gardermoen（落地就睡）
...
## 9/28 → 9/29（周一入住） · Reykjanesbær / Njarðvík（KEF 旁）
...
## 9/29 → 9/30（周二入住） · Oslo Gardermoen（冰岛飞回来）
...
## 10/6 → 10/7 · （条件性）奥斯陆机场 —— 只在 Kevin 的回程是 10/7 时才需要
