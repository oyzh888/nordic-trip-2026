...
out = pathlib.Path("out_fly_air2")
out.mkdir(parents=True, exist_ok=True)

JOBS = [
    ("P-svj-tos-0925", "SVJ", "TOS", "2026-09-25"),
    ("P-svj-boo-0925", "SVJ", "BOO", "2026-09-25"),
    ("P-boo-tos-0925", "BOO", "TOS", "2026-09-25"),
    ("P-svj-tos-1120", "SVJ", "TOS", "2026-11-20"),
    ("P-svj-tos-0605", "SVJ", "TOS", "2027-06-04"),
]
