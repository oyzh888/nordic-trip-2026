...
const TDAYS = [
  { d: '10/6', wd: '二', city: 'osl→nice', tz: 2, title: '奥斯陆道别 → 飞尼斯',
    blocks: [
      { k: 'sleep', a: 0, b: 7.5 },
...
const FIXES = {
  '10/6': '<b>10/6 那天的航班压在上班时间上</b>（法国时间 19:00 开工，20:15 才落地，21:15 到住处）。三个解法：'
    + '① <b>跟团队说当天晚开工 2 小时</b>（最简单）· ② 挪威航空多数航班有免费 Wi-Fi，可以在飞机上先处理消息 · '
    + '③ 改飞 <b>10/7 周三上午</b>（挪威航空 10:00 → 12:55 这班 10/6 是 $139；10/7 的价我还没查），那天没会，10/6 晚在奥斯陆机场酒店多住一晚，尼斯变 3 晚。'
    + '<br>⛔ 10/6 上午 10:00 那班不能选 —— 正好压在 09:00–11:00 的周二例会上。',
